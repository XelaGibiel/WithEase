...
External modules live in %APPDATA%/AccessMate/modules/, one folder each:
...
The class must inherit accessmate.modules.base.BaseModule.  A module that
...
def _load_module(folder, manifest_path) -> BaseModule:
    ...
    spec = importlib.util.spec_from_file_location(
        f"accessmate_external.{folder.name}", entry)

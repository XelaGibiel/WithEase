...
if TYPE_CHECKING:
    from accessmate.modules.macros import Macro, MacrosModule
...
class _StepDialog(QDialog):
    ...
    def __init__(self, step: dict[str, Any] | None = None,
        ...
        self._build_ui()
        from accessmate.gui.ui_utils import compact_fields, em
        compact_fields(self)
    ...
    def _start_capture(self) -> None:
        ...
        from accessmate.core.win_keyboard_hook import shared_keyboard_hook
...
class _MacroDialog(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        self._step_list.setStyleSheet(theme.selection_qss("QListWidget"))
...
class MacrosSettingsWidget(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self._table.setStyleSheet(theme.selection_qss("QTableWidget"))
    ...
    def _on_add(self) -> None:
        ...
        if dlg.exec() == QDialog.DialogCode.Accepted:
            from accessmate.modules.macros import Macro

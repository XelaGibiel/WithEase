...
Curated model: the page lists only official modules from the AccessMate index
(:mod:`accessmate.core.module_store`).  Installing downloads the module into
%APPDATA%/AccessMate/modules/ and prompts for a restart (modules are loaded at
...
from accessmate.core import module_store

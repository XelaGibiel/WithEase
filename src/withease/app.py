...
class WithEaseApp:
    def __init__(self, qt_app: QApplication) -> None:
        ...
        # External (third-party) modules from %APPDATA%/WithEase/modules/.
        ...
        from withease.core.module_loader import discover_external_modules
        ...
        from withease.gui.widgets.click_lock_indicator import ClickLockIndicator
        from withease.gui.widgets.cursor_indicator import (
            CenteringIndicator,
            PrecisionIndicator,
        )
        from withease.gui.widgets.modifier_indicator import ModifierIndicator
        from withease.gui.widgets.macro_indicator import MacroModeIndicator
        from withease.gui.widgets.cursor_highlight_overlay import CursorHighlightOverlay
        ...
        # translucent always-on-top window created too early can stay invisible
        # (the "target symbol missing after reboot" issue) – two attempts cover
        # the settling period.
    ...
    def _prewarm_overlays(self) -> None:
        ...
        __init__) so they show reliably after a cold Windows autostart."""
        for overlay in (self._centering_indicator, self._precision_indicator,
                        self._click_lock_indicator):
            try:
                overlay.prewarm()
            except Exception:
                pass

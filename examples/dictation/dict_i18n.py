...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "win.compact": "⤡ Kompakt",
        "win.full": "⤢ Voll",
        "tip.compact": "Kompakte Ansicht: nur Text, Status und Einfügen / Kopieren / Schließen. Alles andere geht weiter per Sprachbefehl. Auch per Sprache: „kompakte Ansicht“.",
    ...
    "en": {
        ...
        "win.compact": "⤡ Compact",
        "win.full": "⤢ Full",
        "tip.compact": "Compact view: only the text, the status and Insert / Copy / Close. Everything else still works by voice. By voice too: 'kompakte Ansicht'.",

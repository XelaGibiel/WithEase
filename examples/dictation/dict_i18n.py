...
STRINGS: dict[str, dict[str, str]] = {
    "de": {
        ...
        "pron.no_engine": "Kein lokaler Erkenner bereit. Das Anlernen braucht Whisper oder Parakeet auf diesem PC.",
    ...
    "en": {
        ...
        "pron.no_engine": "No local recogniser ready. Teaching needs Whisper or Parakeet on this PC.",
